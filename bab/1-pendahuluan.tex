...
pengendara antarframe. Kombinasi ini efektif untuk analisis lalu lintas berbasis
...
peristiwa dicatat sebagai metadata terstruktur dan disimpan dalam data mart.
...
\begin{enumerate}
  ...
  \item Bagaimana mengintegrasikan YOLOv8 dan ByteTrack pada pemrosesan video real-time agar inferensi menjadi \textit{event stream} dengan konteks spasial dan temporal?

  \item Bagaimana merancang skema data mart untuk menyimpan peristiwa pelanggaran helm secara sistematis agar mendukung analisis pola lalu lintas dan tren keselamatan di Itera?
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Mengimplementasikan integrasi YOLOv8 dan ByteTrack pada pemrosesan video real-time untuk menghasilkan \textit{event stream} pelanggaran helm dengan konteks spasial dan temporal.

  \item Merancang dan mengimplementasikan data mart analitik sebagai bagian dari arsitektur data warehouse untuk menyimpan hasil deteksi pelanggaran helm secara historis. Hasilnya mendukung analisis pola lalu lintas dan keputusan keselamatan berbasis data di Itera.
...
\begin{enumerate}
  ...
  \item Pengumpulan dan pengujian data dilakukan dalam rentang waktu tertentu, yaitu pada periode 5 Februari.
